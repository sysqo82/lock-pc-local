document.addEventListener('DOMContentLoaded', () => {
    ...
    const socket = API_CONFIG && API_CONFIG.wsUrl ? io(API_CONFIG.wsUrl, { transports: ['websocket'] }) : (window.io ? io({ transports: ['websocket'] }) : null);
    ...
    async function loadReminders() {
        try {
            const url = API_CONFIG ? API_CONFIG.getUrl('api/reminder') : '/api/reminder';
    ...
    async function deleteReminder(id) {
        ...
        try {
            const url = API_CONFIG ? API_CONFIG.getUrl(`api/reminder/${id}`) : `/api/reminder/${id}`;
        ...
        reminderForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (editingReminderId) {
                    const url = API_CONFIG ? API_CONFIG.getUrl(`api/reminder/${editingReminderId}`) : `/api/reminder/${editingReminderId}`;
                    res = await fetch(url, {
                        method: 'PUT',
                        headers: {
